...
import ConfirmDelete from "../card/card-deleta-usuario";
import SwitchUsuario from "../form/switch-usuario";
        ...
        cell: ({ row }) => {
            return (
                <div className="flex gap-2">
                    ...
                    <ConfirmDelete usuarioNome={row.original.nome} id={row.original.id} />
                </div>
            )
        }
    }
